...
Feature: Registration, my account, login, existing user checkout
	...
	Scenario: Registering as a new user
		...
		And  I take a screenshot with name "hk_terms_and_conditions_1"
		And  I scroll down
		#TERMS AND CONDITIONS
		And  I take a screenshot with name "hk_terms_and_conditions_2"
		And  I scroll down
		#TERMS AND CONDITIONS
		And  I take a screenshot with name "hk_terms_and_conditions_3"
		And  I go back
	...
	Scenario: Checkout with existing user
		...
		And  I wait up to 30 seconds for "button" to appear in webview
		Then I wait for final loading to be complete
		Then I take a screenshot with name "hk_order_confirmation_existing"
		...
		Then I take a screenshot with name "hk_order_number_existing"
		And  I ensure that no account is logged in for "en"