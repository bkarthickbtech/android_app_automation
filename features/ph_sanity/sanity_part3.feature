...
Feature: Banners, checkout & country switch
	...
	Scenario: Introductory message & banner links
		When I wait up to 30 seconds for "Philippines" to appear
		And  I touch the "Philippines" text
		And  I wait for 1 seconds
		#INTRODUCTORY MESSAGE
		And  I take a screenshot with name "ph_intro_message"
		...
		And  I check that the currency of the products are "P"
		And  I go back
	...
	Scenario: Checkout with existing user with voucher
		...
		Then I take a screenshot with name "ph_order_confirmation_existing_voucher"
		Then I wait for final loading to be complete
	    ...
	    Then I take a screenshot with name "ph_order_number_existing_voucher"
		And  I ensure that no account is logged in for "en"
	...
	Scenario: Checkout new user no voucher
		...
		Then I wait for final loading to be complete
		And  I verify the text "Your Order"
		Then I take a screenshot with name "ph_order_confirmation_new"
		And  In webview I click "div.txtCenter.pbl button.btn.cta.js_checkoutBtn"
	    Then I wait up to 60 seconds for "Thank you for your order!" to appear
	    Then I take a screenshot with name "ph_order_number_new"
		And  I ensure that no account is logged in for "en"
