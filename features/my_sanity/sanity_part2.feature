...
Feature: Catalogs, PDV and cart
	...
	Scenario: Catalogs
		...
		And  I click on a brand and check that the products are valid with "RM" currency
		And  I go back
		And  I scroll down
		And  I click on a brand and check that the products are valid with "RM" currency
		And  I go back
	...
	Scenario: PDV
		...
		#SCREEN OVERLAY
		And  I take a screenshot with name "my_product_page"
		And  I press view with id "fullScreenBtn"
		#FULL SCREEN VIEW
		And  I take a screenshot with name "my_fullscreen_view"
		And  I go back
		And  I wait up to 30 seconds for the view with id "estimatedDelivery" to appear
		...
		And  I take a screenshot with name "my_reviews_and_ratings"
		And  I go back
		And  I wait up to 30 seconds for the view with id "estimatedDelivery" to appear
		And  I scroll down
		And  I scroll down
		#DESCRIPTION
		And  I take a screenshot with name "my_product_description"
		And  I scroll up
		And  I scroll up
		And  I touch the "Add to Cart" text
	...
	Scenario: Add to Cart & Remove from cart & Empty cart view
		...
		#ITEM LIST
		And  I take a screenshot with name "my_product_list"
